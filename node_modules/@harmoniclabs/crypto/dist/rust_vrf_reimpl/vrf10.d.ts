...
export declare function vrf10_ed25519_sha512_ell2_generate_proof(secret_key: Uint8Array, public_key: Uint8Array, alpha_string: Uint8Array): IVrfProof10;
export declare function vrf10_ed25519_sha512_ell2_verify_proof(public_key: Uint8Array, alpha_string: Uint8Array, proof: IVrfProof10): boolean;
export declare function vrf10_proof_to_hash(proof: IVrfProof10): Uint8Array & {
    length: 64;
};
...
**/
export declare function vrf10_ed25519_sha512_ell2_hash_to_curve(public_key: Uint8Array, alpha_string: Uint8Array): EdwardsPoint;
export declare function scalar_hash_from_bytes(input: Uint8Array): Uint8Array;
export declare function vrf10_ed25519_sha512_ell2_nonce_generation(secret_extension: Uint8Array, compressed_h: Uint8Array): Uint8Array;
export declare function vrf10_ed25519_sha512_ell2_compute_challenge(compressed_h: Uint8Array, compressed_gamma: Uint8Array, compressed_announcement_1: Uint8Array, compressed_announcement_2: Uint8Array): Uint8Array;
