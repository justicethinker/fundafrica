...
var curve_js_1 = require("./abstract/curve.js");
var edwards_1 = require("./abstract/edwards.js");
var hash_to_curve_js_1 = require("./abstract/hash-to-curve.js");
var modular_js_1 = require("./abstract/modular.js");
var montgomery_1 = require("./abstract/montgomery.js");
...
var Fp = /* @__PURE__ */ (function () { return (0, modular_js_1.Field)(ED25519_P, undefined, true); })();
 ...
 */
exports.ed25519 = (function () { return (0, edwards_1.twistedEdwards)(ed25519Defaults); })();
function ed25519_domain(data, ctx, phflag) {
    if (ctx.length > 255)
        throw new Error('Context is too big');
    return (0, utils_1.concatBytes)((0, uint8array_utils_1.fromUtf8)('SigEd25519 no Ed25519 collisions'), new Uint8Array([phflag ? 1 : 0, ctx.length]), ctx, data);
}
exports.ed25519ctx = (function () {
    return (0, edwards_1.twistedEdwards)(__assign(__assign({}, ed25519Defaults), { domain: ed25519_domain }));
})();
exports.ed25519ph = (function () {
    return (0, edwards_1.twistedEdwards)(Object.assign({}, ed25519Defaults, {
...
exports.x25519 = (function () {
    return (0, montgomery_1.montgomery)({
        ...
        powPminus2: function (x) {
            ...
            var _a = ed25519_pow_2_252_3(x), pow_p_5_8 = _a.pow_p_5_8, b2 = _a.b2;
...
function edwardsToMontgomeryPub(edwardsPub) {
    var y = exports.ed25519.ExtendedPoint.fromHex(edwardsPub).y;
    var _1n = BigInt(1);
...
var ELL2_C1 = /* @__PURE__ */ (function () { return (Fp.ORDER + _3n) / _8n; })(); // 1. c1 = (q + 3) / 8       # Integer arithmetic
var ELL2_C2 = /* @__PURE__ */ (function () { return Fp.pow(_2n, ELL2_C1); })(); // 2. c2 = 2^c1
var ELL2_C3 = /* @__PURE__ */ (function () { return Fp.sqrt(Fp.neg(Fp.ONE)); })(); // 3. c3 = sqrt(-1)
// prettier-ignore
...
var ELL2_C1_EDWARDS = /* @__PURE__ */ (function () { return (0, modular_js_1.FpSqrtEven)(Fp, Fp.neg(BigInt(486664))); })(); // sgn0(c1) MUST equal 0
function map_to_curve_elligator2_edwards25519(u) {
    var _a = map_to_curve_elligator2_curve25519(u), xMn = _a.xMn, xMd = _a.xMd, yMn = _a.yMn, yMd = _a.yMd; //  1.  (xMn, xMd, yMn, yMd) =
...
var htf = /* @__PURE__ */ (function () {
    return (0, hash_to_curve_js_1.createHasher)(exports.ed25519.ExtendedPoint, function (scalars) { return map_to_curve_elligator2_edwards25519(scalars[0]); }, {
...
// Calculates 1/√(number)
var invertSqrt = function (number) { return uvRatio(_1n, number); };
var MAX_255B = /* @__PURE__ */ BigInt('0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff');
var bytes255ToNumberLE = function (bytes) {
...
function calcElligatorRistrettoMap(r0) {
    ...
    var _a = uvRatio(Ns, D), Ns_D_is_sq = _a.isValid, s = _a.value; // 5
    var s_ = mod(s * r0); // 6
 ...
 */
var RistPoint = /** @class */ (function () {
    // Private property to discourage combining ExtendedPoint + RistrettoPoint
    // Always use Ristretto encoding/decoding instead.
    function RistPoint(ep) {
        this.ep = ep;
    }
    RistPoint.fromAffine = function (ap) {
     ...
     */
    RistPoint.hashToCurve = function (hex) {
     ...
     */
    RistPoint.fromHex = function (hex) {
        hex = (0, utils_js_1.ensureBytes)('ristrettoHex', hex, 32);
        var _a = exports.ed25519.CURVE, a = _a.a, d = _a.d;
        var P = exports.ed25519.CURVE.Fp.ORDER;
        var mod = exports.ed25519.CURVE.Fp.create;
        ...
        var _b = invertSqrt(mod(v * u2_2)), isValid = _b.isValid, I = _b.value; // 7
        var Dx = mod(I * u2); // 8
        var Dy = mod(I * Dx * v); // 9
        var x = mod((s + s) * Dx); // 10
        if ((0, modular_js_1.isNegativeLE)(x, P))
    ...
    RistPoint.msm = function (points, scalars) {
        var Fn = (0, modular_js_1.Field)(exports.ed25519.CURVE.n, exports.ed25519.CURVE.nBitLength);
     ...
     */
    RistPoint.prototype.toRawBytes = function () {
        var _a = this.ep, x = _a.ex, y = _a.ey, z = _a.ez, t = _a.et;
        var P = exports.ed25519.CURVE.Fp.ORDER;
        var mod = exports.ed25519.CURVE.Fp.create;
        ...
        var u2sq = mod(u2 * u2);
        var invsqrt = invertSqrt(mod(u1 * u2sq)).value; // 3
    ...
    RistPoint.prototype.toHex = function () {
        return (0, utils_js_1.bytesToHex)(this.toRawBytes());
    };
    RistPoint.prototype.toString = function () {
        return this.toHex();
    };
    // Compare one point to another.
    RistPoint.prototype.equals = function (other) {
        assertRstPoint(other);
        var _a = this.ep, X1 = _a.ex, Y1 = _a.ey;
        var _b = other.ep, X2 = _b.ex, Y2 = _b.ey;
        var mod = exports.ed25519.CURVE.Fp.create;
    ...
    RistPoint.prototype.add = function (other) {
        assertRstPoint(other);
        return new RistPoint(this.ep.add(other.ep));
    };
    RistPoint.prototype.subtract = function (other) {
        assertRstPoint(other);
        return new RistPoint(this.ep.subtract(other.ep));
    };
    RistPoint.prototype.multiply = function (scalar) {
        return new RistPoint(this.ep.multiply(scalar));
    };
    RistPoint.prototype.multiplyUnsafe = function (scalar) {
        return new RistPoint(this.ep.multiplyUnsafe(scalar));
    };
    RistPoint.prototype.double = function () {
        return new RistPoint(this.ep.double());
    };
    RistPoint.prototype.negate = function () {
...
var hashToRistretto255 = function (msg, options) {
    var d = options.DST;
    var DST = typeof d === 'string' ? (0, uint8array_utils_1.fromUtf8)(d) : d;
