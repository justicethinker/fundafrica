...
import { ProjPointType as PointType, VerOpts } from './curves/weierstrass.js';
import type { Hex, PrivKey } from './abstract/utils.js';
import { bytesToNumberBE, numberToBytesBE } from './abstract/utils.js';
export declare const secp256k1: Readonly<{
    create: (hash: import("./abstract/utils.js").CHash) => import("./curves/weierstrass.js").CurveFn;
    CURVE: Readonly<{
        ...
        readonly isTorsionFree?: ((c: import("./curves/weierstrass.js").ProjConstructor<bigint>, point: PointType<bigint>) => boolean) | undefined;
        readonly clearCofactor?: ((c: import("./curves/weierstrass.js").ProjConstructor<bigint>, point: PointType<bigint>) => PointType<bigint>) | undefined;
    ...
    sign: (msgHash: Hex, privKey: PrivKey, opts?: import("./curves/weierstrass.js").SignOpts | undefined) => import("./curves/weierstrass.js").RecoveredSignatureType;
    verify: (signature: Hex | {
        r: bigint;
        s: bigint;
    }, msgHash: Hex, publicKey: Hex, opts?: VerOpts | undefined) => boolean;
    ProjectivePoint: import("./curves/weierstrass.js").ProjConstructor<bigint>;
    Signature: import("./curves/weierstrass.js").SignatureConstructor;
    utils: {
...
export declare const Secp256k1Point: import("./curves/weierstrass.js").ProjConstructor<bigint>;
/**
